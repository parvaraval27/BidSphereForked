...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="http://localhost:3000" class="button" target="_blank" rel="noopener noreferrer">Start Bidding Now</a>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="http://localhost:5000/bidsphere/${'{auctionId}'}/bid/editauto/${'{auctionId}'}" 
            ...
            <p>Or open this link manually:<br>
               <a href="http://localhost:5000/bidsphere/${'{auctionId}'}/bid/editauto/${'{auctionId}'}" 
                  ...
                  http://localhost:5000/bidsphere/${'{auctionId}'}/bid/editauto/${'{auctionId}'}
               </a>
            </p>
